...
- **Cards:** the TCGplayer market, low, mid and high price for each printing (holofoil, reverse holo, first
  ...
  TCGplayer**.
- **Market:** the biggest gains and drops over 24 hours, 7 days or 30 days, and the most valuable cards right now.
...
backend/
  Pricing/
    ...
    PriceGuideService.cs     Read side: sets, set detail with stats, card detail with history, search, movers, top cards
...
frontend/src/
  ...
  components/                Layout, card tile, Shop link, price history chart, movers table
